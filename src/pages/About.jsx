      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 mt-6 max-w-2xl mx-auto leading-relaxed">
            ...
            tracking, automate reporting, and empower institutions with real-time
            insights.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="group relative p-px rounded-2xl transition-all duration-300 hover:-translate-y-2">
            ...
            {/* Card */}
            <div className="relative z-10 bg-deepNavy border border-white/10 rounded-2xl p-10">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            {[
              ...
              <div
                key={index}
                className="group relative p-px rounded-xl transition-all duration-300 hover:-translate-y-2"
              >
                {/* Glow */}
                <div className="absolute inset-0 rounded-xl bg-rosePink opacity-0 blur-xl transition-all duration-500 group-hover:opacity-40"></div>
