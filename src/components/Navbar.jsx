...
const Navbar = () => {
  ...
  return (
    <div className="w-full top-6 z-50 fixed flex justify-center">
          ...
          >
            ...
            >
              <ul className="flex flex-col gap-6 text-white font-medium">
                <li className="active:text-amberGold hover:text-amberGold focus:text-amberGold transition text-center duration-200 cursor-pointer" onClick={() => setMenuOpen(false)}>
                  Home
                </li>
                <li className="active:text-amberGold hover:text-amberGold focus:text-amberGold transition text-center duration-200 cursor-pointer" onClick={() => setMenuOpen(false)}>
                  Features
